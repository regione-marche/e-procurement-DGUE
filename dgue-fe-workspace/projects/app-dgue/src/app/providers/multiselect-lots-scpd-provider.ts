...
export class MultiselectLotsSCPDProvider extends SdkBaseService implements SdkProvider {
    ...
    public run(args: IDictionary<any>): Function {
        ...
        let jsonLots;
        if (jsonStorage.selezione.supplyContractsPerformanceDeliveries != null) {
            jsonLots = jsonStorage.selezione.supplyContractsPerformanceDeliveries.lotId;
        }
