...
export class MultiselectLotsSCPSProvider extends SdkBaseService implements SdkProvider {
    ...
    public run(args: IDictionary<any>): Function {
        ...
        let jsonLots;
        if (jsonStorage.selezione.serviceContractsPerformanceServices != null) {
            jsonLots = jsonStorage.selezione.serviceContractsPerformanceServices.lotId;
        }
